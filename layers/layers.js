...
var format_MassasDgua_5 = new ol.format.GeoJSON();
var features_MassasDgua_5 = format_MassasDgua_5.readFeatures(json_MassasDgua_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MassasDgua_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MassasDgua_5.addFeatures(features_MassasDgua_5);
var lyr_MassasDgua_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MassasDgua_5, 
                style: style_MassasDgua_5,
                popuplayertitle: 'Massas D\'água',
                interactive: true,
                title: '<img src="styles/legend/MassasDgua_5.png" /> Massas D\'água'
            });
var format_RiosDuplos_6 = new ol.format.GeoJSON();
var features_RiosDuplos_6 = format_RiosDuplos_6.readFeatures(json_RiosDuplos_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RiosDuplos_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RiosDuplos_6.addFeatures(features_RiosDuplos_6);
var lyr_RiosDuplos_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RiosDuplos_6, 
                style: style_RiosDuplos_6,
                popuplayertitle: 'Rios Duplos',
                interactive: true,
                title: '<img src="styles/legend/RiosDuplos_6.png" /> Rios Duplos'
            });
var format_RiosSimples_7 = new ol.format.GeoJSON();
var features_RiosSimples_7 = format_RiosSimples_7.readFeatures(json_RiosSimples_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RiosSimples_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RiosSimples_7.addFeatures(features_RiosSimples_7);
var lyr_RiosSimples_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RiosSimples_7, 
                style: style_RiosSimples_7,
                popuplayertitle: 'Rios Simples',
                interactive: true,
                title: '<img src="styles/legend/RiosSimples_7.png" /> Rios Simples'
            });
...
var group_HidrografiaFBDS = new ol.layer.Group({
                                layers: [lyr_APP_4,lyr_MassasDgua_5,lyr_RiosDuplos_6,lyr_RiosSimples_7,lyr_Nascentes_8,],
                                fold: 'close',
...
lyr_APP_4.set('fieldAliases', {'fid': 'fid', 'GEOCODIGO': 'GEOCODIGO', 'MUNICIPIO': 'MUNICIPIO', 'UF': 'UF', 'CD_UF': 'CD_UF', 'HIDRO': 'HIDRO', 'APP_M': 'APP_M', 'AREA_HA': 'AREA_HA', });
lyr_MassasDgua_5.set('fieldAliases', {'fid': 'fid', 'GEOCODIGO': 'GEOCODIGO', 'MUNICIPIO': 'MUNICIPIO', 'UF': 'UF', 'CD_UF': 'CD_UF', 'HIDRO': 'HIDRO', 'NATUREZA': 'NATUREZA', 'RIO': 'RIO', 'SETOR': 'SETOR', 'AREA_HA': 'AREA_HA', });
lyr_RiosDuplos_6.set('fieldAliases', {'fid': 'fid', 'GEOCODIGO': 'GEOCODIGO', 'MUNICIPIO': 'MUNICIPIO', 'UF': 'UF', 'CD_UF': 'CD_UF', 'HIDRO': 'HIDRO', 'AREA_HA': 'AREA_HA', });
lyr_RiosSimples_7.set('fieldAliases', {'fid': 'fid', 'GEOCODIGO': 'GEOCODIGO', 'MUNICIPIO': 'MUNICIPIO', 'UF': 'UF', 'CD_UF': 'CD_UF', 'HIDRO': 'HIDRO', 'COMP_KM': 'COMP_KM', });
lyr_Nascentes_8.set('fieldAliases', {'fid': 'fid', 'GEOCODIGO': 'GEOCODIGO', 'MUNICIPIO': 'MUNICIPIO', 'UF': 'UF', 'CD_UF': 'CD_UF', 'HIDRO': 'HIDRO', });
...
lyr_APP_4.set('fieldImages', {'fid': 'TextEdit', 'GEOCODIGO': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'UF': 'TextEdit', 'CD_UF': 'Range', 'HIDRO': 'TextEdit', 'APP_M': 'TextEdit', 'AREA_HA': 'TextEdit', });
lyr_MassasDgua_5.set('fieldImages', {'fid': 'TextEdit', 'GEOCODIGO': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'UF': 'TextEdit', 'CD_UF': 'Range', 'HIDRO': 'TextEdit', 'NATUREZA': 'TextEdit', 'RIO': 'TextEdit', 'SETOR': 'TextEdit', 'AREA_HA': 'TextEdit', });
lyr_RiosDuplos_6.set('fieldImages', {'fid': 'TextEdit', 'GEOCODIGO': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'UF': 'TextEdit', 'CD_UF': 'Range', 'HIDRO': 'TextEdit', 'AREA_HA': 'TextEdit', });
lyr_RiosSimples_7.set('fieldImages', {'fid': 'TextEdit', 'GEOCODIGO': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'UF': 'TextEdit', 'CD_UF': 'Range', 'HIDRO': 'TextEdit', 'COMP_KM': 'TextEdit', });
lyr_Nascentes_8.set('fieldImages', {'fid': 'TextEdit', 'GEOCODIGO': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'UF': 'TextEdit', 'CD_UF': 'Range', 'HIDRO': 'TextEdit', });
...
lyr_APP_4.set('fieldLabels', {'fid': 'hidden field', 'GEOCODIGO': 'hidden field', 'MUNICIPIO': 'hidden field', 'UF': 'hidden field', 'CD_UF': 'hidden field', 'HIDRO': 'inline label - visible with data', 'APP_M': 'inline label - visible with data', 'AREA_HA': 'inline label - visible with data', });
lyr_MassasDgua_5.set('fieldLabels', {'fid': 'hidden field', 'GEOCODIGO': 'hidden field', 'MUNICIPIO': 'hidden field', 'UF': 'hidden field', 'CD_UF': 'hidden field', 'HIDRO': 'inline label - visible with data', 'NATUREZA': 'inline label - visible with data', 'RIO': 'inline label - visible with data', 'SETOR': 'inline label - visible with data', 'AREA_HA': 'inline label - visible with data', });
lyr_RiosDuplos_6.set('fieldLabels', {'fid': 'hidden field', 'GEOCODIGO': 'hidden field', 'MUNICIPIO': 'hidden field', 'UF': 'hidden field', 'CD_UF': 'hidden field', 'HIDRO': 'inline label - visible with data', 'AREA_HA': 'inline label - visible with data', });
lyr_RiosSimples_7.set('fieldLabels', {'fid': 'no label', 'GEOCODIGO': 'no label', 'MUNICIPIO': 'no label', 'UF': 'no label', 'CD_UF': 'no label', 'HIDRO': 'no label', 'COMP_KM': 'no label', });
lyr_Nascentes_8.set('fieldLabels', {'fid': 'hidden field', 'GEOCODIGO': 'hidden field', 'MUNICIPIO': 'hidden field', 'UF': 'hidden field', 'CD_UF': 'hidden field', 'HIDRO': 'inline label - visible with data', });
